              ...
              (fun _ ->
                  toAsync (
                      task {
                          ...
                          let deepNesting =
                              violationsIn violations deep |> List.filter (fun v -> v.Type = Nesting)
                          ...
                          let severeNesting =
                              violationsIn violations severe |> List.filter (fun v -> v.Type = Nesting)
                          ...
                          let tryNesting =
                              violationsIn violations tryNested |> List.filter (fun v -> v.Type = Nesting)
