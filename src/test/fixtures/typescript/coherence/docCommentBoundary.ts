function largeFunction0(): number {
    const v0 = 0;
    const v1 = 1;
    const v2 = 2;
    const v3 = 3;
 ...
 * past the 20-line large-function threshold and add a spurious sixth large function. Line counts
 * must exclude the following binding's documentation. */
function largeFunction5(): number {
    const v0 = 0;
    const v1 = 1;
    const v2 = 2;
    const v3 = 3;
